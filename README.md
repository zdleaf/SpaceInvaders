Coursework for Distributed Systems module. The goal is to add some functionality to handle networking and consistency issues in existing multiplayer games. 
